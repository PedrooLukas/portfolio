...
const Contato = () => {
  return (
    <div id='contato' className='text-white text-center mt-2rem'>
        ...
        <p className='text-[14px] md:text-[18px] text-white text-center mb-[5rem]'> Estou sempre disponível, Indenpedente se você tem apenas uma simples pergunta ou quer dizer olá, responderei você o mais rápido possível. Sinta-se a vontade para mandar qualquer mensagem sobre alguma notícia de emprego.</p>
        </div>
        <div>
            <div>
            ...
            <div className='m-5 flex gap-5 justify-center '>
                ...
                <a href="https://www.linkedin.com/in/pedro-lukas-167aa9368/" className='hover:text-[#A8F1FF]'><span>Linkdin <FontAwesomeIcon icon={faArrowUpRightFromSquare} /> </span></a>
